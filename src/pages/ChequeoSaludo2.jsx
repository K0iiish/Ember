...
export default function ChequeoSaludo2() {
    ...
    <StarBackground glowSrc="/assets/glow-ellipse-magenta.svg">
      ...
      >
        ...
        >
          ...
          >
            Antes de comenzar, te haré 10 preguntas rápidas para conocerte mejor :)
          </p>
      ...
      >
        Tomará menos de 3 minutos y nos ayudará a personalizar tus desafíos para ti.
      </p>

      {/* Continuar button — white pill */}
      <button
        onClick={() => navigate('/chequeo/test/1')}
